            ...
            <div class="card-body p-4">
                ...
                <div class="table-responsive">
                    <form name="programBasicInfo" id="programBasicInfo" method="POST"
                        onsubmit='sendingPostRequest(event,`{{route("request.addProgram")}}`)'>
                        <fieldset>
                            ...
                            <br />
                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">Add Program</button>
                        </fieldset>
                    </form>
                </div>
            </div>
