...
<div class="row">
    <div class="d-flex justify-content-center">
        <a type="button" href="{{route('governmentStaff.create',['orgId'=>$orgId])}}" class="btn btn-outline-primary">Add
            Government Staff</a>
    </div>
</div>
<br />
...
<div class="row">
    <div class="card w-100">
        <div class="card-body p-4">
            <h5 class="card-title fw-semibold mb-4">Government Staff</h5>
            <div class="table-responsive">
                <table id="table" data-filter-control-multiple-search="true"
                    ...
                    data-url="{{route('api.governmentStaff.index')}}" data-pagination="true"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-filter-control="input" data-field="staff_category.name" data-sortable="true">Staff Category</th>
                            ...
                            <th data-filter-control="input" data-field="uid" data-formatter="operateEdit" data-force-hide="true"
                                data-force-hide="true" data-print-ignore="true">
                                Edit</th>
                            <th data-filter-control="input" data-field="uid" data-formatter="operateFormatter"
