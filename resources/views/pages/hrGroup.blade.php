...
<div class="row">
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            <div class="row">
                @if(session('user')->roles[0]->name === "admin" || session()->get('user')->roles[0]->name ==="bxssUser"
                || session()->get('user')->roles[0]->name === "hrRep")
                <div class="d-flex flex-wrap">
                    ...
                    ==="bxssUser")
                    <button class="print-action-button btn btn-primary mb-2">Print Bagde</button>&nbsp;
                    <button class="print-action-button-with-pic btn btn-success mb-2">Print Bagde With
                        Picture</button>&nbsp;
                    @endif
                </div>
                @endif
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th data-filter-control="input" data-field="isPrinted" data-sortable="true"
                                data-formatter="operateYesNo" data-force-hide="true" data-print-ignore="true">Printed
                            </th>
