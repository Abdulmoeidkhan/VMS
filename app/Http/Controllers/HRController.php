...
class HRController extends Controller
{
    ...
    public function getHrGroupStaff($id)
    {
        ...
        foreach ($hrGroupsStaff as $key => $staff) {
            ...
            // $hrGroupsStaff[$key]->pictureUrl = 'https://res.cloudinary.com/dj6mfrbth/image/upload/v'.time().'/Images/' . $staff->uid . '.png';
            $hrGroupsStaff[$key]->pictureUrl = asset('storage/images/'. $staff->uid . '.png');
